...
C3K2_CLASS = (C3k2_Faster, C3k2_ODConv, C3k2_Faster_EMA, C3k2_DBB, C3k2_DeepDBB, C3k2_WDBB, C3k2_CloAtt, C3k2_SCConv, C3k2_ScConv, C3k2_EMSC, C3k2_EMSCP, C3k2_KW, C3k2_DySnakeConv, C3k2_DCNv2, C3k2_DCNv3,
              ...
              C3k2_TSSA, C3k2_SAVSS, C3k2_MobileMamba, C3k2_MambaOut, C3k2_MambaOut_UniRepLK, C3k2_EfficientVIM, C3k2_EfficientVIM_CGLU, C3k2_FAT, C3k2_LEGM, C3k2_RCB
              )
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
            ...
            A2C2f_DYT, A2C2f_CGLU_DYT, A2C2f_DFFN_DYT, CSP_MSCB_SC, C2PSA_FMFFN, C2PSA_CGLU, A2C2f_FMFFN, A2C2f_FMFFN_DYT
        ) + C3K2_CLASS):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in ((
                ...
                C2TSSA_DYT, C2Pola_DYT, A2C2f_DYT, A2C2f_CGLU_DYT, A2C2f_DFFN_DYT, CSP_MSCB_SC, C2PSA_FMFFN, C2PSA_CGLU, A2C2f_FMFFN, A2C2f_FMFFN_DYT
            ) + C3K2_CLASS):
